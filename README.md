...
**Student Name:** Nurassyl Serik  
**Group:** SE-2525  
**University:** Astana IT University

## Description
This repository contains the completed individual Tasks 1 through 4 for Assignment #1 in Web Development.

### Summary of Tasks:
- **Task 1: Introduction to HTML & CSS** - Personal introduction webpage featuring a profile card, ordered and unordered lists, stylized links with hover effects, and CSS selectors.
